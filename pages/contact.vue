            ...
            <div class="bg-surface rounded-lg shadow-card p-8">
              ...
              <div class="flex gap-4">
                ...
                >
                  ...
                  <svg class="relative z-10 w-6 h-6 text-text-light group-hover:text-primary transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div class="bg-surface rounded-lg shadow-card p-8">
            ...
            <form class="space-y-6" @submit.prevent="handleSubmit">
              <div class="space-y-1">
                ...
                <p v-if="errors.name" id="name-error" class="text-sm text-red-500 mt-1">{{ errors.name }}</p>
              </div>
              ...
              <div class="space-y-1">
                ...
                <p v-if="errors.email" id="email-error" class="text-sm text-red-500 mt-1">{{ errors.email }}</p>
              </div>
              ...
              <div class="space-y-1">
                ...
                <p v-if="errors.message" id="message-error" class="text-sm text-red-500 mt-1">{{ errors.message }}</p>
              </div>
