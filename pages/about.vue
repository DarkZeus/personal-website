<template>
  <div>
    <HeroSection class="min-h-screen flex flex-1 items-center justify-center relative">
      ...
      <template #scroll-indicator>
        <div class="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce">
          <span class="text-text-light text-sm">Scroll to explore</span>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      <section class="py-24 relative overflow-hidden">
        ...
        <div class="absolute top-1/4 right-0 w-64 h-64 rounded-full bg-primary/5 blur-3xl"></div>
          ...
          <div class="grid gap-16 lg:grid-cols-2">
            ...
            <div class="space-y-8">
              <div class="bg-surface rounded-lg shadow-card p-8 relative overflow-hidden">
                ...
                <p class="text-lg text-text-light leading-relaxed text-pretty">
                ...
                <div class="space-y-6">
                  <div>
                    ...
                    <div class="flex flex-wrap gap-2">
                      <skill-tag class="text-pretty">JavaScript (ES6+)</skill-tag>
                      <skill-tag class="text-pretty">TypeScript</skill-tag>
                      <skill-tag class="text-pretty">HTML5</skill-tag>
                      <skill-tag class="text-pretty">CSS3/SCSS/BEM</skill-tag>
                    </div>
                  </div>
                  <div>
                    <h3 class="text-xl font-semibold text-text mb-4 text-balance">Frontend Frameworks</h3>
                    <div class="flex flex-wrap gap-2">
                      <skill-tag>React</skill-tag>
                      <skill-tag>Redux (RTK)</skill-tag>
                      <skill-tag>Vue.js 2/3</skill-tag>
                      <skill-tag>Nuxt</skill-tag>
                      <skill-tag>Pinia</skill-tag>
                      <skill-tag>Vue Router</skill-tag>
                      <skill-tag>Zustand</skill-tag>
                      <skill-tag>TanStack</skill-tag>
                    </div>
                  </div>
                  <div>
                    <h3 class="text-xl font-semibold text-text mb-4 text-balance">UI Libraries & Design</h3>
                    <div class="flex flex-wrap gap-2">
                      <skill-tag>Material UI</skill-tag>
                      <skill-tag>TailwindCSS</skill-tag>
                      <skill-tag>Shadcn/UI</skill-tag>
                      <skill-tag>Chakra UI</skill-tag>
                    </div>
                  </div>
                  <div>
                    <h3 class="text-xl font-semibold text-text mb-4 text-balance">Backend & Databases</h3>
                    <div class="flex flex-wrap gap-2">
                      <skill-tag>PHP (Laravel)</skill-tag>
                      <skill-tag>Python</skill-tag>
                      <skill-tag>PostgreSQL</skill-tag>
                      <skill-tag>MySQL</skill-tag>
                      <skill-tag>SQLite</skill-tag>
                      <skill-tag>IndexedDB</skill-tag>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="space-y-8">
                  <div class="relative pl-8">
                    ...
                    <div>
                      ...
                      <div class="mt-4 flex flex-wrap gap-2">
                        <skill-tag>React</skill-tag>
                        <skill-tag>Redux</skill-tag>
                        <skill-tag>SCSS</skill-tag>
                        <skill-tag>Material UI</skill-tag>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="relative pl-8">
                    ...
                    <div>
                      ...
                      <div class="mt-4 flex flex-wrap gap-2">
                        <span class="px-3 py-1 rounded-md text-sm font-medium bg-primary/10 text-primary">Laravel</span>
                        <span class="px-3 py-1 rounded-md text-sm font-medium bg-primary/10 text-primary">Vue 2</span>
                  ...
                  <div class="relative pl-8">
                    ...
                    <div>
                      ...
                      <div class="mt-4 flex flex-wrap gap-2">
                        <span class="px-3 py-1 rounded-md text-sm font-medium bg-primary/10 text-primary">HTML/CSS</span>
                        <span class="px-3 py-1 rounded-md text-sm font-medium bg-primary/10 text-primary">JavaScript</span>
                        <span class="px-3 py-1 rounded-md text-sm font-medium bg-primary/10 text-primary">jQuery</span>
                        <span class="px-3 py-1 rounded-md text-sm font-medium bg-primary/10 text-primary">Vue 2</span>
                      </div>
                    </div>
                  </div>
